...
const PayrollIdentityPreparation = () => {
  ...
  const handleBackfill = () => {
    if (window.confirm('This will generate sequential employee codes (YVI001, YVI002...) for all employees who do not have one. This is a one-time setup action. Proceed?')) {
