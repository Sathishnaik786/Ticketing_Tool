...
export default function PayslipTemplateGovernance() {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState<any>({
    ...
    organization_name: 'YVI Enterprise EMS',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="bg-slate-950 border-white/10 rounded-xl text-xs py-5 text-white"
                  placeholder="e.g. YVI Enterprise EMS"
                />
              </div>
            </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="text-[7px] space-y-0.5 leading-tight">
                      ...
                      <p className="flex justify-between"><span className="font-bold text-slate-500">Code:</span> <span className="font-semibold">YVI0021</span></p>
