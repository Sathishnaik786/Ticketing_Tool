...
export const ETMS_GROUP_ITEM_IDS: Record<string, string[]> = {
  ...
  'knowledge-base': ['kb-articles', 'kb-analytics'],
  communications: ['comms-chat', 'comms-timeline', 'comms-analytics'],
  ...
  administration: ['admin-users', 'admin-departments', 'admin-settings'],
