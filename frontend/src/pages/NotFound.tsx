    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white font-sans p-8 relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <h1 className="text-7xl md:text-9xl font-display font-black tracking-tighter text-white uppercase leading-[0.85]">Lost in <br /><span className="text-teal-500 text-gradient-teal">Nexus.</span></h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          <Link to="/app/dashboard" className="w-full sm:w-auto">
            <Button variant="ghost" size="lg" className="w-full px-12 rounded-2xl h-24 text-[11px] font-black uppercase tracking-[0.3em] border border-white/5 hover:bg-white/5 text-slate-400 hover:text-white transition-all">
