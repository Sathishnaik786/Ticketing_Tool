      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="absolute right-0 mt-3 w-[420px] bg-white dark:bg-slate-950/95 backdrop-blur-2xl rounded-[2rem] shadow-2xl z-[100] overflow-hidden border border-white/10 flex flex-col h-[520px]"
          >
            {/* Header */}
